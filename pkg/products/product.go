...
func (p *Product) setPaymentMethodText(input string) {
	...
	case "1":
		...
		p.vars["{payment_method_instruction}"] = "ENTER YOUR MPESA PIN in the next screen that asks you \"Do you want to pay to kcb-bank Account no: 7617541\" to complete your transaction."
